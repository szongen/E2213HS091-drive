...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DO_SCREEN_DC_Pin|DO_SCREEN_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA0 PA6 PA8 PA9
                           PA10 PA11 PA12 PA15 */
  ...
  HAL_GPIO_Init(DI_SCREEN_BUSY_GPIO_Port, &GPIO_InitStruct);
