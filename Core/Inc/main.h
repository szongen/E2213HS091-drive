...
/* Private defines -----------------------------------------------------------*/
#define DI_SCREEN_BUSY_Pin GPIO_PIN_1
#define DI_SCREEN_BUSY_GPIO_Port GPIOA
#define DO_SCREEN_DC_Pin GPIO_PIN_2
#define DO_SCREEN_DC_GPIO_Port GPIOA
#define DO_SCREEN_RST_Pin GPIO_PIN_3
#define DO_SCREEN_RST_GPIO_Port GPIOA
#define DO_SCREEN_CS_Pin GPIO_PIN_4
#define DO_SCREEN_CS_GPIO_Port GPIOA
#define DO_SCREEN_CLK_Pin GPIO_PIN_5
#define DO_SCREEN_CLK_GPIO_Port GPIOA
#define MO_SCREEN_MOSI_Pin GPIO_PIN_7
